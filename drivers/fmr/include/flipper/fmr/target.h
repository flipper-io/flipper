...
struct _target {
	...
	uint32_t (* const push)(uint8_t object, uint8_t index, uint8_t argc, void *source, fmr_size_t length, ...);
	uint32_t (* const pull)(uint8_t object, uint8_t index, uint8_t argc, void *destination, fmr_size_t length, ...);
...
struct _self {
	...
	uint32_t (* const push)(uint8_t object, uint8_t index, uint8_t argc, fmr_size_t length);
	uint32_t (* const pull)(uint8_t object, uint8_t index, uint8_t argc, fmr_size_t length);
...
uint32_t host_push(uint8_t object, uint8_t index, uint8_t argc, void *source, fmr_size_t length, ...);
uint32_t host_pull(uint8_t object, uint8_t index, uint8_t argc, void *destination, fmr_size_t length, ...);
