...
static const uint8_t PROGMEM device_descriptor[] = {
    ...
    lo(FLIPPER_USB_VENDOR_ID),  // idVendor LO
    hi(FLIPPER_USB_VENDOR_ID),  // idVendor HI
    lo(USB_PRODUCT_ID),         // idProduct LO
    hi(USB_PRODUCT_ID),         // idProduct HI
    0x00,
    0x01,  // bcdDevice
    1,     // iManufacturer
    2,     // iProduct
...
static const struct usb_string PROGMEM language = { 0x04, 0x03, { 0x0409 } };

static const struct usb_string PROGMEM manufacturer = { sizeof(USB_MANUFACTURER), 0x03, USB_MANUFACTURER };

static const struct usb_string PROGMEM product = { sizeof(USB_PRODUCT), 0x03, USB_PRODUCT };
...
const struct _descriptor PROGMEM descriptors[] = {
    ...
    { 0x0301, 0x0409, (const uint8_t *)(&manufacturer), sizeof(USB_MANUFACTURER) },
    { 0x0302, 0x0409, (const uint8_t *)(&product), sizeof(USB_PRODUCT) },
};
